...
/**
 * {@link VertxElasticsearchClient.FailureListener} implementation that allows to perform
 * sniffing on failure. Gets notified whenever a failure happens and uses a {@link Sniffer} instance
 * to manually reload hosts and sets them back to the {@link VertxElasticsearchClient}.
 * The {@link Sniffer} instance needs to be lazily set through {@link #setSniffer(Sniffer)}.
 */
public class SniffOnFailureListener extends VertxElasticsearchClient.FailureListener {
