...
public interface NodeSelector {
     ...
     * client would prefer to use them and implementers should remove
     * nodes that should not receive the request. Implementers may
     ...
     * have the {@code master} role OR it has the {@code data} role.
     */
